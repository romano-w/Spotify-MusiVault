...
from app.data_access import SpotifyDataStorage
from app.data_collector import SpotifyDataCollector
...
def authorize():
    ...
    # Use the comprehensive data collection system
...
def fetch_and_print_spotify_data(sp):
    """Legacy helper for manual debugging."""
    user_info = get_user(sp)
...
def collect_data_manually():
    """Manual data collection info page."""
    return '''
        ...
        <p><strong>Note:</strong> Data collection uses the SpotifyDataCollector system with database storage.</p>
    '''
...
# Expose a module-level app instance for tests while keeping the factory pattern
app = create_app()
